...
SessionCheck is an example of an Embedded Domain Specific Language (EDSL) in Haskell.
%
The language constructs can be seen in Figure \ref{fig:SessionCheck:language}.
%
