...
\todo[inline]{Spell out GCMP at first use}
%
...
\todo[inline]{More detailed explanation of how this works}
...
Section~\ref{sec:verification}) and SessionCheck (described in
Section~\ref{sec:SessionCheck}).
%
%TODO: perhaps also add GCMP \ref{sec:GCMP}
