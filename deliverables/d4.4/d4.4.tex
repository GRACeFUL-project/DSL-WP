...
\todo[inline]{Refer to GCMP section}
...
\todo[inline]{Say something about session check stuff.}
...
\todo[inline]{Refer to section where we explain testing of GRACe programs}
