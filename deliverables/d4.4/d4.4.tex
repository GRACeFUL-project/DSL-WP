...
\todo{describe our prototype RAT}

\todo{introduce property based testing}

\todo{perhaps other testing/verification techniques we make use of.}

\todo{Testing of communicating systems: keeping components and protocols in sync}

\todo{Testing solvers and backends: challenges and partial solutions}
