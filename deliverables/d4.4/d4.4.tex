...
\section*{D4.4 Testing and verification framework for RATs with applications to the CRUD case study}

Contributions by: Maximilian Algehed, Sólrún
...
%
The work leading up to this deliverable is within
Task 4.5 ``Build a testing and verification framework for RATs'' and the full
...
\todo{Introduce RATs, our prototype RAT, property based testing, other
  testing/verification techniques we make use of.}
