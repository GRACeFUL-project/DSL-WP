...
%
\todo{please relate this to ``contraint variable'' in the CFP
  direction and ``factor'' in the GCM direction}
%
...
As can be seen there is a clear separation of concerns in GL between
