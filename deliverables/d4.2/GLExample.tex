...
\todo{The \verb+pump+ and \verb+rain+ components are so close the the
  examples above that it would be good to make them identical and skip
  them here (just refer to the previous subsection).}
