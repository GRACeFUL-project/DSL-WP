...
%Ultimately a \ac{GCM} is translated (via the \ac{DSL}) to
%a \ac{CFP}, which is analysed by a constraint solver.  The results of the
%constraint solver are presented to the stakeholders.
